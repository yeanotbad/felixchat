...
async function init() {
  ...
  const starter=[
['legend','LEGEND','tag','legendary','rainbow',1,0],['og','OG','tag','rare','gold',1,1],['neon','NEON','name_effect','epic','neon',1,1],['fire','FIRE','name_effect','legendary','fire',1,0],['early','EARLY USER','tag','uncommon','blue',1,1],['halo','HALO','profile_frame','epic','halo',1,1],
